...
1. [GitHub Issues](https://github.com/CleverStack/clever-users/issues)
...
4. Please follow the [coding guidelines](https://github.com/CleverStack/clever-users/blob/master/.jshintrc)
5. Push your changes and submit a [pull request](https://github.com/CleverStack/clever-users/compare/) to the master branch.